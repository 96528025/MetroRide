...
public interface ClassifiedFailure {
     ...
     * the only way a retryable entry is ever given up on; a {@link FailureClass#FATAL} failure is
     * never dead-lettered and has none.
     */
    Optional<DeadLetterReason> deadLetterReason();
}
